...
<%	String adminName = (String)session.getAttribute("adminname");
 System.out.println("用户名"+adminName);
		...
		//JOptionPane.showMessageDialog(null,"您还未填写简历，请前往新增简历进行填写");
		//break;
		}
		}
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="name" id="name" value=<%=resume.getName() %> lay-verify="title" autocomplete="off" placeholder="请输入姓名" class="layui-input">
    </div>
  </div>
 ...
 <div class="layui-form-item">    
    ...
    <div class="layui-input-inline">
      ...
      <select name="sex" id="sex" lay-filter="aihao">
        <option value=<%=resume.getSex()%> selected="selected"><%=resume.getSex()%></option>
   ...
   <div class="layui-form-item">  
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="date" id="date" value=<%=resume.getBirthDate()%> lay-verify="date" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
      </div>
    </div>
    </div>
   ...
   <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <select name="nation" id="nation" lay-verify="required" lay-search="">
          <option value=<%=resume.getNation()%> ><%=resume.getNation()%> </option>
   ...
   <div class="layui-inline">
    ...
    <div class="layui-input-block">
      <select name="marryStatus" id="marryStatus" lay-filter="aihao">
        <option value=<%=resume.getMarriage()%>  selected=""><%=resume.getMarriage()%></option>
   ...
   <div class="layui-inline">
    ...
    <div class="layui-input-block">
      <select name="politicsStatus" id="politicsStatus" lay-filter="aihao">
        <option value=<%=resume.getPoliticStatus()%> selected=""><%=resume.getPoliticStatus()%></option>
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="school" id="school" value=<%=resume.getSchool()%> lay-verify="title" autocomplete="off" placeholder="请输入毕业院校" class="layui-input">
    </div>
  </div>
    ...
    <div class="layui-input-block">
      <input type="text" name="major" id="major" value=<%=resume.getLearnMajor()%> lay-verify="title" autocomplete="off" placeholder="请输入您的专业" class="layui-input">
    </div>
  </div>
   ...
   <div class="layui-inline">
    ...
    <div class="layui-input-block">
      <select name="qualification" id="qualification" lay-filter="aihao">
        <option value=<%=resume.getDegree()%> selected=""><%=resume.getDegree()%></option>
    ...
    <div class="layui-input-block">
      <input type="text" name="residence" id="residence" value=<%=resume.getLivingPlace()%> lay-verify="title" autocomplete="off" placeholder="请输入现居住地" class="layui-input">
    </div>
  </div>
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="nativePlace" id="nativePlace" value=<%=resume.getNativePlace()%> lay-verify="title" autocomplete="off" placeholder="请输入籍贯" class="layui-input">
    </div>
  </div>
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="price" id="price" value=<%=resume.getExpectSalary()%> placeholder="￥" autocomplete="off" class="layui-input">
      </div>
       </div>
  </div>
   <div class="layui-form-item">
   <div class="layui-inline">
    ...
    <div class="layui-input-block">
      <select name="jobStatus" id="jobStatus" lay-filter="aihao">
        <option value=<%=resume.getWorkStatus()%> selected=""><%=resume.getWorkStatus()%></option>
    ...
    <div class="layui-input-block">
      <input type="text" name="technologySpecialty" value=<%=resume.getSkill()%> id="technologySpecialty" lay-verify="title" autocomplete="off" placeholder="请输入技术特长" class="layui-input">
    </div>
  </div>
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="workExperience" value=<%=resume.getWorkExper()%> id="workExperience" lay-verify="title" autocomplete="off" placeholder="请输入您的工作经历" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="tel" name="phone" id="phone" value=<%=resume.getPhone()%> lay-verify="required|phone" autocomplete="off" class="layui-input" placeholder="请输入常用的手机号">
      </div>
    </div>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
      <textarea placeholder="请输入内容" class="layui-textarea" id="personalIntroduction" name="personalIntroduction"><%=resume.getIntroduce()%></textarea>
    </div>
  </div>
...
<div class="layui-form-item">
  <div class="layui-inline">
    <label class="layui-form-label"></label>
    <div class="layui-input-block">
      <input type="radio" name="agree" value="1" title="是" checked="checked">
...
function register(){ 
  ...
  var userInfoID=<%=resume.getUserInfoID()%>;
  ...
  //alert("!!");
  var expectSalary = document.getElementById("price").value;
