...
#form1 {
  ...
  <legend align="center"  style="font-size: 28px;color:black;">hqu招聘会管</legend>
</fieldset>


 <legend align="center" class="layui-icon" style="font-size: 18px; color:#009688;">用户登录</legend>
<br>
  ...
  <div class="layui-container">
   ...
   <div class="layui-row" style="margin-bottom: 10px">
    <div class="layui-col-md2  layui-col-md-offset3" ><i class="layui-icon layui-icon-username" style="font-size: 30px;"></i><label class="layui-form-label">用户名:</label></div>
      ...
      <input type="text" name="email" lay-verify="username" id="form1" placeholder="请输入username" class="layui-input" value="${email}">
      </div>
   ...
   <div  class="layui-col-md2 layui-col-md-offset3 "><i class="layui-icon layui-icon-password" style="font-size: 30px;"></i><label class="layui-form-label">密码:</label></div>
    <div class="layui-col-md4">
      <input type="password"  name="password" lay-verify="title" id="form1" autocomplete="off" placeholder="请输入password" class="layui-input" value="${userpwd}">
    </div>
    <div class="layui-col-md3" ></div>
    </div>
   ...
   <div  class="layui-col-md2  layui-col-md-offset3"><i class="layui-icon layui-icon-release" style="font-size: 30px;"></i><label class="layui-form-label">验证码:</label></div>
    <div class="layui-col-md2">
      <input type="text" name="checkcode" lay-verify="check" id="form1" autocomplete="off" placeholder="请输入验证码" class="layui-input">
    </div>
 ...
 <legend align="center" class="layui-icon" style="font-size: 11px; color:black;"> © hqu招聘会馆 - higher brothers</legend>
</div>
...
$.backstretch([
		'layui/images/yaoshui.jpg',
		'layui/images/zw2.jpg',
		'layui/images/zw3.jpg',
		'layui/images/zw4.jpg',
		'layui/images/stym4.jpg',
	], {
		fade : 1000, // 动画时长
		duration : 2000 // 切换延时
});
