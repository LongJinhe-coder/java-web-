...
<html>
 ...
 <meta charset="utf-8">
  ...
  <li class="layui-nav-item "><a href="firmregister.jsp">企业注册</a></li>
  <li class="layui-nav-item layui-this"><a href="personalregister.jsp">应聘者注册</a></li>
</ul>
<br>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="title" value="${title}" id="title" contenteditable="true" lay-verify="title" autocomplete="off" placeholder="用户名即您的邮箱" class="layui-input">
    </div>
  </div>
 ...
 <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="tel" name="phone" id="phone" value="${phone}" lay-verify="required|phone" autocomplete="off" class="layui-input" placeholder="请输入常用的手机号">
      </div>
    </div>
  ...
  <div class="layui-form-item">
   ...
   <label class="layui-form-label">验证码</label>
    ...
    <div class="layui-col-md2">
	   ...
	   <input class="layui-btn layui-btn-radius" type="submit" value="换一张" onclick="document.getElementById('form').action='ChangeCheckCode2'"/>
    </div>
    </div>
...
<div class="layui-form-item">
 <div class="layui-inline">
    ...
    <div class="site-demo-button" id="layerDemo" style="margin-bottom: 0;">
        ...
        <a href="agreement.jsp">我已阅读并同意相关服务条款和隐私政策（点击阅读）</a>
        </div>
    </div>
  </div>
    </div>
...
if(localStorage.getItem("tododata")){
    title.innerHTML = localStorage.getItem("tododata");    
}
  </script>
...
layui.use(['form', 'layedit', 'laydate'], function(){
 ...
 function refresh(){
  ...
  location.href="personalregister.jsp";
  }
 ...
 //alert("注册中");
  ...
  location.href="UserServlet?option=addAccount&name="+name+"&email="+email+"&password="+password+"&phone="+phone+"&check="+check+"";
  }
