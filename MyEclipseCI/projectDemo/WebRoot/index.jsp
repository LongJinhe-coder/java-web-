...
<html>
  ...
  <c:when test="${adminname eq '龙金河'}">
      	<div style="font-size: 50px;margin-top: 15%;text-align: center;">亲爱的BOSS<font size="30px" color="green">${adminname}</font>,</br>欢迎您登录Higher Brothers招聘会馆后台管理系统，
      	<br/>您比普通管理员拥有更多权限！</div>
	</c:when>
	<c:otherwise>
