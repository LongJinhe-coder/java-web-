  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="username" id="username" autocomplete="off" class="layui-input" placeholder="请输入账号">
      </div>
      <div class="layui-input-inline">
      <input name="option" value="addAdmin" style="visibility:hidden" class="layui-input">
    </div>
    </div>
...
function confirmAdd(){
	var x=document.getElementById("form");
     ...
     //location.href="AdminServlet?option=addAdmin&url=addAdmin.jsp&username="+username+"&password="+password+"";
}
</script>
</html>
