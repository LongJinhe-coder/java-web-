...
<form class="layui-form" action="" method="post" id="form">
    ...
    <div class="layui-input-block">
      <input type="text" name="firmname" id="firmname" lay-verify="title" autocomplete="off" placeholder="请输入企业名称" class="layui-input">
    </div>
  
  <div class="layui-form-item">
    <label class="layui-form-label">注册号</label>
    <div class="layui-input-block">
      <input type="text" name="firmid" id="firmid" lay-verify="required" lay-reqtext="注册号是必填项，岂能为空？" placeholder="请输入注册号" autocomplete="off" class="layui-input">
    </div>
  </div>
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" name="email" id="email" lay-verify="email" autocomplete="off" class="layui-input" placeholder="邮箱将用作您的用户名">
       </div>
      </div>
    </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="tel" name="phone" lay-verify="required|phone" autocomplete="off" class="layui-input" placeholder="请输入企业常用的手机号">
      </div>
    </div>
    </div>
     <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="tel" name="money" id="money" autocomplete="off" class="layui-input" placeholder="请输入企业注册资金">
      </div>
    </div>
 ...
 <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="registerplace" id="registerplace" autocomplete="off" placeholder="xx省-xx市-xx区/县" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="place"  id="place" autocomplete="off" placeholder="请输入企业的详细所在地" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
   ...
   <div class="layui-inline">
    ...
    <div class="layui-input-block">
      <input type="text" name="linkmanname" id="linkmanname" autocomplete="off" placeholder="请输入联系人姓名" class="layui-input">
    </div>
  </div>
    ...
    <div class="layui-inline">
      <label class="layui-form-label">手机号</label>
      <div class="layui-input-inline">
        <input type="tel" name="linkmanphone" id="linkmanphone" lay-verify="required|phone" autocomplete="off" class="layui-input" placeholder="请输入联系人的手机号">
      </div>
    </div>
   </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="intro" id="intro" autocomplete="off" placeholder="请输入企业简介：" class="layui-input">
    </div>
  </div>
