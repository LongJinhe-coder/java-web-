...
//传pageNo,pageSize是为了删除后回到当前界面
 ...
 function lookInfo(recruitmentID,pageNo,pageSize){
   location.href="RecruitmentInfo?option=lookInfo&recruitmentID="+recruitmentID+"&pageNo="+pageNo+"&pageSize="+pageSize+"&url=recruitmentInfo.jsp";
 }
  ...
  function refresh(){
  location.href="RecruitmentInfo?option=queryByPage&url=recruitmentInfo.jsp";
  }
   function show () {
