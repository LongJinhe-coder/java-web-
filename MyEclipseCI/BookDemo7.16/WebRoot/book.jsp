...
<%@page import="com.etc.entity.Book1"%>
...
<html>
       ...
       %>
        <tr>
            ...
            <td colspan="2">
              ...
              <a href="javascript:toEnd(<%=totalPage %>,<%=pageSize %>)">尾页</a>
            </td>
        </tr>
  ...
  <script type="text/javascript">
	function toFirst(){
	location.href="BookServlet?option=queryByPage&pageNo=1&pageSize=<%=pageSize %>";
	}
	...
	location.href="BookServlet?option=queryByPage&pageNo=<%=pageNo-1 %>&pageSize=<%=pageSize %>";
	}
	...
	function toEnd(totalPage,pageSize){
	location.href="BookServlet?option=queryByPage&pageNo="+totalPage+"&pageSize="+pageSize+"";
	}
</script>
</html>
